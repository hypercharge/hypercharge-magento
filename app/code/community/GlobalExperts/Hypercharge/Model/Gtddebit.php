...
class GlobalExperts_Hypercharge_Model_Gtddebit extends GlobalExperts_Hypercharge_Model_Mobile {

    protected $_code = 'hypercharge_mobile_gtd';
    protected $_formBlockType = 'bithypercharge/form_gtddebit';
